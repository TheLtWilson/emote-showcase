                    ...
                    body.data.forEach((emote, index, array) => {
                        ...
                        if (countedEmotes === array.length) {
                            ...
                            FollowerEmotes.forEach(emote => {
                                ...
                                tippy(x, {
                                    allowHTML: true,
                                    content: `<img src=${x.src.toString()}><br><b>${emote.name.toString()}</b><br>Follower Emote<br>Click to Follow`,
                                    arrow: true
                                });
                            });
                            ...
                            T1Emotes.forEach(emote => {
                                ...
                                x.addEventListener("click", () => {
                                    window.open(`https://subs.twitch.tv/${displayname}`, target="_blank")
                                });
                                ...
                                tippy(x, {
                                    allowHTML: true,
                                    content: `<img src=${x.src.toString()}><br><b>${emote.name.toString()}</b><br>Tier 1 Sub Emote<br>Click to Get Emote`,
                                    arrow: true
                                });
                            });
                            ...
                            T2Emotes.forEach(emote => {
                                ...
                                tippy(x, {
                                    allowHTML: true,
                                    content: `<img src=${x.src.toString()}><br><b>${emote.name.toString()}</b><br>Tier 2 Sub Emote<br>Click to Get Emote`,
                                    arrow: true
                                });
                            });
                            ...
                            T3Emotes.forEach(emote => {
                                ...
                                tippy(x, {
                                    allowHTML: true,
                                    content: `<img src=${x.src.toString()}><br><b>${emote.name.toString()}</b><br>Tier 3 Sub Emote<br>Click to Get Emote`,
                                    arrow: true
                                });
                            });
                            ...
                            AnimatedEmotes.forEach(emote => {
                                ...
                                tippy(x, {
                                    allowHTML: true,
                                    content: `<img src=${x.src.toString()}><br><b>${emote.name.toString()}</b><br>Animated Emote<br>Click to Get Emote`,
                                    arrow: true
                                });
                            });
                        }
